...
public class CricketTournament {
    static CricketProperties cricketProperties = new CricketProperties();
    ...
    void buildPlayerMatrix(String[] names, int[][] probMatrix, int overs) {
    ...
    void chaseTarget(String teamName) throws IOException {
        secondTeam = teamName;
    ...
    void  setTarget(String teamName) throws IOException {
        firstTeam = teamName;
        commentaryPrint.println("Sample commentary");
        commentaryPrint.println();
    ...
    void setChase(String teamName) throws IOException {
        secondTeam = teamName;
        commentaryPrint.println();
        commentaryPrint.println(teamName+" innings");
        Pair<Boolean, Integer> overResult = null;
